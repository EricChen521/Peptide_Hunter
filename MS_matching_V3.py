...
parser.add_argument("-P",type=int,help="Max number of phosphorylation allowed on S/T/Y, Default = True;",default=10)
parser.add_argument("-OH",type=int,help="Max num of hydroxylation allowed on P/K, Default = True;",default=10)
parser.add_argument("-CO2",type=int,help="Max num carboxylation allowed on E, Default = True;",default=10)
parser.add_argument("-Br",type=int,help="Max num bromination allowed on W , Default = True;",default=10 )
...
parser.add_argument("-t",type=float,help="The tolerance of Mass Spec accurancy,Default=0.5 Dalton;",default=0.5)
